...
public class CheckerBoard extends JFrame implements ActionListener, MouseListener, Runnable {
	...
	String gameinfo1 = "Not logged in, into stand-alone mode.";
	String gameinfo2;
	int x, y;
	...
	int blackTime = 0;
	int whiteTime = 0;
	int blackTimeCount = 0; 
	int whiteTimeCount = 0; 
	...
	public CheckerBoard() {
		...
		tf1.setFont(new Font("ËÎÌו", Font.BOLD, 12));
		tf1.setHorizontalAlignment(SwingConstants.CENTER);
		tf2.setEditable(false);
		tf2.setFont(new Font("ËÎÌו", Font.BOLD, 12));
